...
public class proyecto {
    ...
    private static final String URL = "jdbc:mysql://localhost:3307/reclamoempresaelectrica";
    private static final String USER = "root";
    private static final String PASSWORD = "nueva_contraseña";
    ...
    public static int Listar(Scanner sc) {
        ...
        try {
            ...
            PreparedStatement ps = conn.prepareStatement("SELECT COUNT(*) AS cantidad FROM reclamo WHERE nro_usuario = ?");
            ps.setInt(1, nro_ide);
        ...
        try {
            Connection conn = connect();
            PreparedStatement ps = conn.prepareStatement("SELECT nro, fecha, hora, fecha_resol, cod_motivo FROM reclamo WHERE nro_usuario = ?");
            ps.setInt(1, nro_ide);
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
